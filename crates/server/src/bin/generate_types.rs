...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::task_attempt_drafts::DraftResponse::decl(),
        server::routes::task_attempt_drafts::UpdateFollowUpDraftRequest::decl(),
        server::routes::task_attempt_drafts::UpdateRetryFollowUpDraftRequest::decl(),
