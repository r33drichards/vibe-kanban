...
**Required Permissions**: Vibe Kanban needs access to your repositories (`repo`), workflow permissions (`workflow`), basic profile info (`read:user`), and email address (`user:email`) for Git commits.
