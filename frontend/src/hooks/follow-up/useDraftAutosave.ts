...
type DraftArgs<TServer, TCurrent> = {
  ...
  current: TCurrent;
  isDraftSending: boolean;
  // Queue-related flags (used for follow_up; optional for retry)
  isQueuedUI?: boolean;
  isQueuing?: boolean;
  isUnqueuing?: boolean;
  // Discriminant
...
export function useDraftAutosave(
  ...
  // Compute skip conditions based on draft type
...
// Retry autosave (deduplicated into the same file)
export type RetrySaveStatus = SaveStatus;

type RetryDraftResponse = {
...
// Note: unified useDraftAutosave replaces useRetryDraftAutosave
